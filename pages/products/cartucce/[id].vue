      ...
      <nav class="flex px-5 py-3 text-gray-700" aria-label="Breadcrumb">
        ...
        >
          <li class="inline-flex items-center">
            <a
              href="/"
              class="inline-flex items-center text-xs uppercase text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white"
            >
              <svg
          ...
          <li>
            <div class="flex items-center">
              ...
              <a
                href="#"
                @click="router.go(-1)"
                class="ms-1 text-xs uppercase text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white"
                >tutti le cartucce</a
              >
            </div>
          </li>
        ...
        >
          ...
          <ul class="mt-6 space-y-6 text-[#333]">
            ...
            <li class="text-sm" v-if="product['Capacità della memoria']">
              ...
              <span style="display: block">{{
                product["Capacità della memoria"]
              }}</span>
            </li>
            ...
            <li
              class="text-sm"
              v-if="product['Tipologia di periferica ottica']"
            >
              <span class="font-bold">Tipologia di periferica ottica</span>
              <span style="display: block">{{
                product["Tipologia di periferica ottica"]
              }}</span>
            </li>
            ...
            <li
              class="text-sm"
              v-if="product['Capacità della batteria al litio']"
            >
              <span class="font-bold">Capacità della batteria al litio</span>
              <span style="display: block">{{
                product["Capacità della batteria al litio"]
              }}</span>
            </li>
            ...
            <li
              class="text-sm"
              v-if="product['Confezione della batteria al litio']"
            >
              <span class="font-bold">Confezione della batteria al litio</span>
              <span style="display: block">{{
                product["Confezione della batteria al litio"]
              }}</span>
            </li>
            <li
              class="text-sm"
              v-if="product['Numero delle celle agli ioni di litio']"
            >
              <span class="font-bold"
                >Numero delle celle agli ioni di litio</span
              >
              <span style="display: block">{{
                product["Numero delle celle agli ioni di litio"]
              }}</span>
            </li>
            <li class="text-sm" v-if="product['Fascia d\'età (descrizione)']">
              <span class="font-bold">Fascia d'età (descrizione)</span>
              <span style="display: block">{{
                product["Fascia d'età (descrizione)"]
              }}</span>
            </li>
            <li
              class="text-sm"
              v-if="product['Aggiornamenti software garantiti fino a']"
            >
              <span class="font-bold"
