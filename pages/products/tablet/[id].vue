  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="#" @click="router.go(-1)" class="ms-1 text-xs uppercase text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">tutti i tablet</a>
      </div>
    </li>
...
<li class="text-sm" v-if="product['Dimensioni prodotto']">
  <span class="font-bold">Dimensioni prodotto</span>
  <span style="display: block;">{{ product['Dimensioni prodotto'] }}</span>
</li>
...
<li class="text-sm" v-if="product.Risoluzione">
  <span class="font-bold">Risoluzione</span>
  <span style="display: block;">{{ product.Risoluzione }}</span>
</li>
<li class="text-sm" v-if="product['Clock di Memoria']">
  <span class="font-bold">Clock di Memoria</span>
  <span style="display: block;">{{ product['Clock di Memoria'] }}</span>
</li>
...
<li class="text-sm" v-if="product['Dimensioni memoria scheda grafica']">
  <span class="font-bold">Dimensioni memoria scheda grafica</span>
  <span style="display: block;">{{ product['Dimensioni memoria scheda grafica'] }}</span>
</li>
